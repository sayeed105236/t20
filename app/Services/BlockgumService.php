...
class BlockgumService
{
 ...
 //   private $client;
    ...
    {
        $this->api_url = config('blockgum.api_url');
        $this->chain = config('blockgum.chain');
        $this->jwt_token = config('blockgum.jwt_token');
        $this->client_id = config('blockgum.client_id');
        $this->security_type = config('blockgum.security_type');
        $this->main_address = config('blockgum.main_address');
        $this->decimals = config('blockgum.decimals', 18);
      //  $this->client = new Client();
        //dd($this->jwt_token,$this->api_url,$this->client_id,$this->main_address,$this->chain,$this->client);
    }
